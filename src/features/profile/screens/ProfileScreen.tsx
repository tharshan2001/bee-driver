...
const styles = StyleSheet.create({
  ...
  avatar: { width: 80, height: 80, borderRadius: 40, backgroundColor: '#1A237E', justifyContent: 'center', alignItems: 'center', marginBottom: 8 },
  avatarText: { color: '#fff', fontSize: 28, fontWeight: 'bold' },
  cameraIcon: { position: 'absolute', bottom: 0, right: -4, backgroundColor: '#fff', borderRadius: 12, padding: 4 },
  editText: { color: '#1976D2', fontSize: 14, fontWeight: '600' },
  ...
  saveButton: { backgroundColor: '#1A237E', borderRadius: 12, padding: 16, alignItems: 'center', marginTop: 24 },
