...
const styles = StyleSheet.create({
  ...
  dropdownTextActive: { color: '#1976D2', fontWeight: '600' },
  ...
  uploadBtnText: { fontSize: 14, color: '#1976D2' },
  submitBtn: { backgroundColor: '#1A237E', borderRadius: 12, padding: 16, alignItems: 'center', marginTop: 32 },
